...
const PublishedBooks = () => {
  ...
  const books: Book[] = [
    {
      ...
      description:
        'Discover the path to self-discovery and unlock your true potential. This transformative guide will help you find clarity, purpose, and inner peace.',
      price: '$24.99',
      originalPrice: '$34.99',
    ...
    },
    {
      ...
      description:
        'Learn how to overcome challenges and rise above any obstacle. A powerful guide to resilience and personal growth.',
      price: '$22.99',
    ...
    },
    {
      ...
      description:
        'Master the art of building meaningful connections and transform your relationships with proven communication techniques.',
      price: '$19.99',
      originalPrice: '$27.99',
    ...
    },
    {
      ...
      description:
        'Unlock the secrets to career success and personal fulfillment. This book provides the roadmap to achieving your professional dreams.',
      price: '$26.99',
    ...
    },
    {
      ...
      description:
        'Find inner peace and tranquility through the practice of mindfulness and meditation. Your journey to a calmer mind starts here.',
      price: '$18.99',
      originalPrice: '$24.99',
    ...
    },
    {
      ...
      description:
        'Transform your leadership style and inspire those around you. Learn to lead with empathy, vision, and purpose.',
      price: '$28.99',
  ...
  return (
    <div
      ref={sectionRef}
      className='min-h-screen bg-gradient-to-b from-white via-purple-50/20 to-white'
    >
      {/* Hero Section */}
      <section className='relative py-20 lg:py-32 overflow-hidden'>
        ...
        <div className='container-large relative z-10 px-4 sm:px-6 lg:px-8 text-center'>
          <div className='anim-hidden max-w-3xl mx-auto'>
            ...
            <h1 className='text-h1 text-white mb-6'>Published Books</h1>
            <p className='text-xl text-purple-100 mb-8 max-w-2xl mx-auto'>
              Transform your life with my collection of bestselling books on
              personal development, relationships, and professional growth.
            </p>
            ...
            {books.map((book, index) => (
              ...
              >
                ...
                <div className='p-6'>
                  ...
                  <h3 className='font-header text-xl text-purple-900 mb-1'>
                    {book.title}
                  </h3>
                  ...
                  <div className='flex items-center justify-between'>
                    <div className='flex items-center gap-2'>
                      <span className='font-header text-2xl text-orange-600'>
                        {book.price}
                      </span>
                      {book.originalPrice && (
      ...
      <section className='py-20 bg-gradient-to-br from-purple-900 to-purple-800'>
        <div className='container-large px-4 sm:px-6 lg:px-8'>
          <div className='anim-hidden max-w-4xl mx-auto text-center'>
            <h3 className='text-h3 text-white mb-6'>Have a Project in Mind?</h3>
            <p className='text-xl text-purple-200 mb-8'>
              You can reach out to me for coaching, collaborations, or just to
              say hi! I'm always excited to connect with fellow writers and
              readers.
            </p>
            <div className='flex flex-col sm:flex-row gap-4 justify-center'>
              <Link
                to={'/contact'}
                className='px-8 py-2 bg-orange-500 text-white rounded-full font-semibold text-base hover:bg-orange-600 transition-all duration-300 hover:scale-105 hover:shadow-xl flex items-center justify-center gap-2'
              >
                {/* <ShoppingCart className='w-5 h-5' /> */}
                Contact Me
              </Link>
              <Link
                ...
                target='_blank'
                className='px-8 py-2 bg-white/10 text-white rounded-full font-semibold text-base hover:bg-white/20 transition-all duration-300 backdrop-blur-sm'
              >
                Hire Me on Upwork
              </Link>
            </div>
          ...
          >
            <div className='grid md:grid-cols-2'>
              ...
              <div className='p-8'>
                ...
                <h2 className='font-header text-3xl text-purple-900 mt-4 mb-2'>
                  {selectedBook.title}
                </h2>
                ...
                <div className='flex items-center justify-between pt-6 border-t border-gray-100'>
                  <div>
                    <span className='font-header text-3xl text-orange-600'>
                      {selectedBook.price}
                    </span>
